...
const getNeighbours4 = (v: Vec4): Vec4[] => {
	const xs: [number, number, number, number] = [v.x - 1, v.x, v.x + 1, 0];
	const ys: [number, number, number, number] = [v.y - 1, v.y, v.y + 1, 0];
	const zs: [number, number, number, number] = [v.z - 1, v.z, v.z + 1, 0];
	const ws: [number, number, number, number] = [v.w - 1, v.w, v.w + 1, 0];
