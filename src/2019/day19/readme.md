...
## [Part One](https://adventofcode.com/2019/day/19#part1) - [TypeScript](./typescript/part_one.ts) - [Rust](./rust/src/lib.rs)
...
## [Part Two](https://adventofcode.com/2019/day/19#part2) - [TypeScript](./typescript/part_two.ts) - [Rust](./rust/src/lib.rs)
...
In this example, the **10x10** square closest to the emitter that fits entirely within the tractor beam has been marked `O`. Within it, the point closest to the emitter (the only highlighted `0`) is at X=`25`, Y=`20`.
